...
- AI chatbot on the home page and individual user dashboards responding to blood donation queries with (persoalized responses) 
...
- FIFO stock consumption on blood request completion to handle blood unit expiration effectively, nurses managing this. 
