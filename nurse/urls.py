...
from nurse.views import UnifiedAppointmentDetailView
from django.conf.urls.static import static
from .views import next_stock_unit
urlpatterns = [
    ...
    path('appointment/<int:pk>/', UnifiedAppointmentDetailView.as_view(), name='nurse-appointment-detail'),
    path('next_stock_unit/', next_stock_unit, name='next_stock_unit'),
    path('pending-approval/', views.nurse_pending_approval_view, name='nurse-pending-approval'),


        path('stock/safety/', views.stock_safety_management, name='stock-safety-management'),
    path('stock/<int:stock_unit_id>/verify/', views.verify_stock_safety, name='verify-stock-safety'),
    path('stock/<int:stock_unit_id>/detail/', views.stock_unit_detail, name='stock-unit-detail'),
]
